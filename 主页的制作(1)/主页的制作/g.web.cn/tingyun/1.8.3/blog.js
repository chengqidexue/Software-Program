var TINGYUN = function(t, e, n) {
    ...
    function o(t, e, n) {
        ...
        if (t)
            if (a(t))
                for (r = t.length; i < r && e.call(t[i], t[i], i) !== !1; i++);
            else
                for (i in t)
    ...
    function ht(t) {
        if (On.pf) {
            ...
            Cn.ulabel && (r.ulabel = Cn.ulabel), Ln.emit("send", "/err1", r, {
                datas: e
            }, m(or.reset, or))
        }
    }
        ...
        return function e() {
            ...
            return new Promise(function(e, n) {
                var a, o, u = "GET",
                    s = 1;
                if (i)
                    if (i.length > 1) a = i[0], o = i[1], s = 1, o && me(o) && (u = o.method);
                    else if (1 === i.length) {
                    var c = i[0];
    ...
    yn.localStorage = mn,
        function() {
            function t() {
                ...
                l.appendChild(s), c.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", n = i = u = !1, r = o = !0, e.getComputedStyle && (f = e.getComputedStyle(c), n = "1%" !== (f || {}).top, u = "2px" === (f || {}).marginLeft, i = "4px" === (f || {
                    width: "4px"
