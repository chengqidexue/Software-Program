! function() {
    ...
    e.object = e.object || {}, e.object.extend = function(e, t) {
            for (var n in t) t.hasOwnProperty(n) && (e[n] = t[n])
        }, e.extend = e.object.extend, e.dom = e.dom || {}, e.dom.g = function(e) {
        ...
        }, e.dom._styleFixer = e.dom._styleFixer || {}, e.dom._styleFilter = e.dom._styleFilter || [], e.dom._styleFilter.filter = function(t, n, o) {
            for (var i, r = 0, a = e.dom._styleFilter; i = a[r]; r++)(i = i[o]) && (n = i(t, n));
            return n
        }, e.string = e.string || {}, e.string.toCamelCase = function(e) {
            ...
            if (t.getBoundingClientRect) l = t.getBoundingClientRect(), r.left = Math.floor(l.left) + Math.max(n.documentElement.scrollLeft, n.body.scrollLeft), r.top = Math.floor(l.top) + Math.max(n.documentElement.scrollTop, n.body.scrollTop), r.left -= n.documentElement.clientLeft, r.top -= n.documentElement.clientTop, o.ie && !o.isStrict && (r.left -= 2, r.top -= 2);
                ...
                for ((o.opera > 0 || o.isWebkit > 0 && "absolute" == e.dom.getStyle(t, "position")) && (r.top -= n.body.offsetTop), s = t.offsetParent; s && s != n.body;) r.left -= s.scrollLeft, b.opera && "TR" == s.tagName || (r.top -= s.scrollTop), s = s.offsetParent
            }
            return r
        }, e.event = e.event || {}, e.event._unload = function() {
            for (var t, n, o = e.event._listeners, i = o.length, r = !!window.removeEventListener; i--;) t = o[i], n = t[0], n.removeEventListener ? n.removeEventListener(t[1], t[3], !1) : n.detachEvent && n.detachEvent("on" + t[1], t[3]);
            r ? window.removeEventListener("unload", e.event._unload, !1) : window.detachEvent("onunload", e.event._unload)
        }, window.attachEvent ? window.attachEvent("onunload", e.event._unload) : window.addEventListener("unload", e.event._unload, !1), e.event._listeners = e.event._listeners || [], e.event.on = function(t, n, o) {
        ...
        }, e.on = e.event.on, e.event.preventDefault = function(e) {
            e.preventDefault ? e.preventDefault() : e.returnValue = !1
        }, e.ui = e.ui || {}, e.suggestion = e.ui.suggestion = e.ui.suggestion || {},
        function() {
            var t = {},
                n = function(e) {
                    var t = {};
                    e.listen = function(n, o) {
                        ...
                        if (t[n])
                            for (var o = 0; o < t[n].length; o++) t[n][o].apply(this, Array.prototype.slice.call(arguments, 1));
                        return e
                    }
                };
            t.extend = function(e) {
                return new n(e), e
            }, t.extend(t), e.suggestion._Central = t
            ...
            function s() {
                if (y && "none" != _.style.display)
                    for (var e = 0; e < y.length; e++)
                        if (y[e].className == h + "mo") return [e, p[e], m[e]];
                return [-1, ""]
            }
            ...
            return w.className = h + "sd", w.style.display = "none", w.style.position = "absolute", w.style.borderWidth = "0px", r.apd_body ? document.body.appendChild(_) : n.parentNode.appendChild(_), _.parentNode.insertBefore(w, _), t.listen("start", function() {
                ...
                a(0, e)
            }), t.listen("key_tab", f), t.listen("key_esfc", f), t.listen("all_clear", f), t.listen("data_ready", function(n, o) {
                v = o, p = [], m = [];
                for (var r = 0, a = o.length; r < a; r++) "undefined" != typeof o[r].input ? (p[r] = o[r].input, m[r] = o[r].selection) : m[r] = p[r] = o[r];
                if (0 != p.length) {
                    y = i(_, m, b);
                    for (var r = 0, a = y.length; r < a; r++) e.on(y[r], "mouseover", function() {
                        l(), this.className = h + "mo", u()
                    }), e.on(y[r], "mouseout", l), e.on(y[r], "mousedown", function(n) {
            ...
            var n = {};
            return e.listen("response_data", function(t, o) {
            ...
            var i, r, a = 0,
                ...
                c = !1,
                f = !1;
            return n.setAttribute("autocomplete", "off"), e.on(n, "keydown", function(n) {
                ...
                u = n.value, a = setInterval(function() {
                    if (!c) {
                        null == e.G(n) && suggestion.dispose();
                        var o = n.value;
                        o == l && "" != o && o != u && o != r ? 0 == i && (i = setTimeout(function() {
                            t.call("need_data", o)
                        }, 100)) : (clearTimeout(i), i = 0, "" == o && "" != l && (r = "", t.call("all_clear")), l = o, o != r && (s = o), u != n.value && (u = ""))
                    }
                }, 10)
            ...
            if (o.options = {
                    ...
                    apd_body: !1
                }, e.extend(o.options, n), !(t = e.G(t))) return null;
            o.inputElement = t, t.id ? o.options._inputId = t.id : t.id = o.options._inputId = o.options.class_prefix + "ipt" + (new Date).getTime(), o._adjustPos = function(n) {
                var i = a.element,
                    r = a.shade,
                    l = document,
                ...
                if ("none" != i.style.display || !n) {
                    ...
                    f = "function" == typeof o.options.view ? o.options.view(f) : f, i.style.display = r.style.display = "block", r.style.top = f[0] + "px", r.style.left = f[1] + "px", r.style.width = f[2] + "px";
                ...
                return c.className = o.options.class_prefix + "app", c.innerHTML = o.options.append_html, e.innerHTML = "", e.appendChild(d), e.appendChild(i), e.appendChild(c), o._adjustPos(), n
            };
            ...
            return i.listen("start", function() {
                setInterval(function() {
                    var e = a.element;
                    0 != e.offsetWidth && t.offsetWidth != e.offsetWidth && o._adjustPos()
                }, 100), e.on(window, "resize", function() {
                    o._adjustPos(!0)
                })
            }), {
                pick: a.pick,
...
var BaiduSuggestion = function() {
    ...
    function t(e, t, a, d) {
        if (e) {
            ...
            if (null == t) var t = [];
                ...
                i(".bdSug_wpr", "border:1px solid " + v + ";position:absolute;z-index:99999;top:28px;left:0;color:" + c), i(".bdSug_wpr td", "font-size:" + f + ";font-family:" + g), i(".bdSug_mo", "background-color:" + p + ";color:" + m)
            }
    ...
    function o(e) {
        ...
        if (e.getBoundingClientRect) {
            ...
            n = i.left + Math.max(t.documentElement.scrollLeft, t.body.scrollLeft), o = i.top + Math.max(t.documentElement.scrollTop, t.body.scrollTop), n -= t.documentElement.clientLeft, o -= t.documentElement.clientTop
        } else
            for (; e = e.offsetParent;) n += e.offsetLeft, o += e.offsetTop;
        return {
            x: n,
            y: o
        }
    ...
    function a() {
        i(".bdSug_wpr", "line-height:normal;background:#FFF;padding:0;margin:0;border:1px solid #817F82;position:absolute;z-index:99999;"), i(".bdSug_wpr table", "padding:0;width:100%;background:#fff;cursor:default;"), i(".bdSug_wpr tr", "padding:0;margin:0;height:30px;line-height:30px"), i(".bdSug_wpr td", "padding:2px;margin:0;text-align:left;vertical-align:middle;font:14px ;font-weight:normal;text-decoration:none;text-indent:0"), i(".bdSug_mo", "background:#36c;color:#fff"), i(".bdSug_app", "padding:0;margin:0;background:#fff"), i(".bdSug_pre", "padding:0;margin:0"), i(".bdsug_copy", "margin:0;background:transparent url(https://www.baidu.com/img/bd.gif) no-repeat;font-size:13px;color:#77c;text-decoration:none;padding:0 2px 0 16px;")
    }
    var l = {},
        s = {},
        u = {
            createSugOptions: function(t, n, o, i) {
                return {
                    ...
                    getData: function(n) {
                        ...
                        var r = e("script");
                        r.setAttribute("charset", "gbk"), r.src = "https://sp0.baidu.com/5a1Fazu8AA54nxGko9WTAnF6hhy/su?wd=" + encodeURIComponent(n) + "&p=3&cb=BaiduSuggestion.callbacks.give" + t + "&t=" + o, r.id = "bdSug_script", document.body.appendChild(r)
                    },
                    append_html: "<div style='background:#FFF;line-height:normal;border:0;text-align:right;margin:0;padding:0;'><a class='bdsug_copy' href='https://help.baidu.com/' ltarget='_blank' >百度搜索框提示</a></div>",
                    apd_body: !0
                }
            },
